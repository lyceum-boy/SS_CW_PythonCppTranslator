...
%type <data> BLOCK_COND IF_PART ELIF_PART ELSE_PART
...
MAIN: BLOCK_FOR BLOCK_PRINTS BLOCK_STRINGS BLOCK_COND BLOCK_WHILE BLOCK_FOR_CONTINUE BLOCK_CALLS BLOCK_WORDS PRINT_STMT {
    strcpy($$, "int main() {\n");
...
BLOCK_COND: IF_PART ELIF_PART ELSE_PART {
    strcpy($$, $1);
    strcat($$, $2);
    strcat($$, $3);
};
